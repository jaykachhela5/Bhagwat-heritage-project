          ...
          <div className="mt-8 grid grid-cols-1 gap-5 md:grid-cols-3">
            {[
              ...
              <div key={tier.label} className="flex h-full flex-col rounded-[24px] border border-white/10 bg-[var(--campaign-surface)] p-5 shadow-sm">
                ...
                <Link to={ROUTES.donate} className="mt-5 inline-flex w-fit rounded-xl bg-[var(--campaign-accent)] px-4 py-2 text-sm font-bold text-white transition-colors hover:bg-[var(--campaign-accent-hover)]">
                  Donate Now
                </Link>
              </div>
            ))}
