...
export const GoogleTranslateWidget = memo(function GoogleTranslateWidget({
  ...
  return (
    <div
      className={`google-translate-widget ${compact ? "google-translate-widget--compact" : "inline-flex items-center gap-2 rounded-xl border border-[#dce9ee] bg-[#fffdf7] px-3 py-2 text-sm text-[#0a5375] shadow-[0_8px_18px_rgba(15,103,140,0.08)]"} ${className}`}
    >
      {compact ? null : <i className="fas fa-language text-[#ef9a1e]" aria-hidden="true" />}
